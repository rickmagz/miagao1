...
<body>
    ...
    <section id="page-locator" style="margin-top: 20px;">
        <div class="container">
            <div class="row">
                <div class="col"><a href="browse.php">Home &gt;</a><a class="text-bg-primary border rounded-pill border-0" href="#">&emsp14;Business Information &emsp13;</a></div>
            </div>
        </div>
    </section>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col" id="business_info">
                                                    ...
                                                    <div class="d-xl-flex justify-content-xl-start">
                                                        ...
                                                        &emsp13;
                                                        <a class="btn btn-outline-primary btn-sm border rounded-pill" href="browse.php">Back to home</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <hr />
