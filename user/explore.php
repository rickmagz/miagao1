...
if (mysqli_num_rows($if_liked) == 1) {
    // The user already liked the product, so unlike it
    mysqli_query($cxn, "DELETE FROM user_product_reactions WHERE userID = '{$_SESSION['user_id']}' AND productID = '$id'");
} else {
    // The user has not liked the product, so like it
    mysqli_query($cxn, "INSERT INTO user_product_reactions (userID, productID) VALUES ('{$_SESSION['user_id']}', '$id')");
}
                ...
                <div class="col">
                    <div class="card" style="border-radius: 12px;">
                        <div id="editproduct_cardbody" class="card-body">
                            <div class="fs-2 mb-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="32" fill="currentColor" class="bi bi-check-square-fill" viewBox="0 0 16 16">
                                            ...
                                            <div class="row">
                                                ...
                                                <div id="business-info" class="col">
                                                    ...
                                                    <div class="d-xl-flex justify-content-xl-start">
                                                        <a class="btn btn-primary btn-sm border rounded-pill" href="unlike.php?id=<?php echo $id; ?>">
