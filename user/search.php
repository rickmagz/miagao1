        ...
        <div class="container py-4 py-xl-5">
            ...
            <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3" style="margin-top: -65px;">
                ...
                if (isset($_POST['search'])) {
                    ...
                    $prod_search_query = mysqli_query($cxn, "SELECT * FROM product_list WHERE product_name LIKE '%$search%' ORDER BY product_name asc") or die("Error in query: $prod_search_query." . mysqli_error($cxn));

                    if ($prod_search_query->num_rows > 0) {
                        while ($p = $prod_search_query->fetch_assoc()) {

                ?>
                            <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                                <div class="card">
                                    <img class="card-img-top w-100 d-block fit-cover" style="height: 200px;" src="../assets/img/business_img/<?php echo $p['product_image']; ?>" />
                                    <div class="card-body p-2 text-center">
                                        <h5 class="card-title"><?php echo $p['product_name']; ?></h5>
                                    </div>
                                    <div class="card-footer text-body-secondary text-center">
                                        <a class="btn btn-outline-primary btn-sm border-primary rounded-pill mt-1" href="./product_view.php?id=<?php echo $p['product_id']; ?>" target="_self">More Info</a>
                                    </div>
                                </div>
                            </div>
                <?php
        ...
        <div class="container py-4 py-xl-5">
            ...
            <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3" style="margin-top: -65px;">
                ...
                if (isset($_POST['search'])) {
                    ...
                    $busi_search_query = mysqli_query($cxn, "SELECT * FROM business_list WHERE business_name LIKE '%$search%' ORDER BY business_name asc") or die("Error in query: $busi_search_query." . mysqli_error($cxn));

                    if ($busi_search_query->num_rows > 0) {
                        while ($b = $busi_search_query->fetch_assoc()) {


                ?>
                            <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                                <div class="card">
                                    <img class="card-img-top w-100 d-block fit-cover" style="height: 200px;" src="../assets/img/business_img/<?php echo $b['business_image']; ?>" />
                                    <div class="card-body p-2 text-center">
                                        <h5 class="card-title"><?php echo $b['business_name']; ?></h5>
                                    </div>
                                    <div class="card-footer text-body-secondary text-center">
                                        <a class="btn btn-outline-primary btn-sm border-primary rounded-pill mt-1" href="./business_view.php?id=<?php echo $b['business_id']; ?>" target="_self">More Info</a>
                                    </div>
                                </div>
                            </div>
                <?php
