        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <a href="editusercredentials.php?id=<?php echo $user_id; ?>">&emsp14;Edit Account Credentials &gt;&emsp14;</a>
                    <a class="text-bg-primary border rounded-pill border-0" href="#">&emsp14;Edit Account Picture &emsp14;</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col">
                    <div class="card" style="border-radius: 12px;">
                        <div id="editproduct_cardbody" class="card-body">
                            <h3>Edit Account Picture</h3>
                            <div class="row row-cols-5">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 text-center">
                                    <form action="savenewimage.php" method="post" name="modimage" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6 offset-xxl-0 align-self-center">
                                                <div class="form-floating mb-3">
                                                    ...
                                                    <input class="form-control" type="file" placeholder="New Account Picture" required style="border-radius: 10px;" name="image" /><label class="form-label">New Account Picture</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xxl-6 align-self-center">
                                                <div class="text-start form-floating mb-3">
                                                    <div class="btn-group btn-group-sm" role="group">
                                                        <button class="btn btn-primary" type="submit" style="margin-right: 8px;border-radius: 10px;" name="updateimg" form="modimage">Change Image</button>
