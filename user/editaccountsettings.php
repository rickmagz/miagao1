        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <a href="editusercredentials.php?id=<?php echo $user_id; ?>">&emsp14;Edit Account Password &gt;&emsp14;</a>
                                    ...
                                    <form id="modaccount" action="saveaccountinfo.php" method="post" name="modaccount">
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6 offset-xxl-0 align-self-center">
                                                <div class="form-floating mb-3"><input class="form-control" type="text" placeholder="First Name" required style="border-radius: 10px;" name="firstname" value="<?php echo $u['first_name']; ?>" /><label class="form-label">First Name</label></div>
                                            </div>
                                            <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6 offset-xxl-0 align-self-center">
                                                <div class="form-floating mb-3"><input class="form-control" type="text" placeholder="Last Name" required style="border-radius: 10px;" name="lastname" value="<?php echo $u['last_name']; ?>" /><label class="form-label">Last Name</label></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6 offset-xxl-0 align-self-center">
                                                <div class="form-floating mb-3"><input class="form-control" type="text" placeholder="Email Address" required style="border-radius: 10px;" name="email" value="<?php echo $u['email']; ?>" /><label class="form-label">E-mail Address</label></div>
                                            </div>
                                        </div>
