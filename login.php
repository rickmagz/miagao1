                        ...
                        <div class="mb-3">
                            <div class="row">
                                ...
                                <div class="col-sm-11 col-xl-10">
                                    <button class="btn btn-primary border rounded-pill shadow d-xl-flex align-items-center align-content-center justify-content-xl-center align-items-xl-center" type="submit" style="color: var(--bs-btn-hover-border-color);background: var(--bs-btn-disabled-color);border-color: var(--bs-btn-active-border-color);">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" class="justify-content-xl-center align-items-xl-center" style="font-size: 20px;">
