            ...
            <div class="row">
                ...
                <div class="col-md-5 col-xl-7 text-center text-md-start">
                    ...
                    <form action="entrep_signup.php" method="post" id="entrep_signup" enctype="multipart/form-data">
                        ...
                        <p class="text-muted">Have an account? <a href="./entrep/">Log in&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-arrow-narrow-right">
