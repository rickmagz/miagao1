...
<head>
    ...
    <title>Features - Miagao Negosyo Center</title>
            ...
            <div class="row gy-4 gy-md-0" data-aos="zoom-out">
                <div class="col-md-5 col-lg-5 offset-md-1 offset-lg-1 text-center text-md-start d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-center">
                    <div style="max-width: 350px;">
                        ...
                        <p class="my-4">See what is popular in list of products and help us recommend it to others.</p><a class="btn btn-primary btn-lg border rounded-pill me-2" role="button" href="signup.html">Sign up</a><a class="btn btn-outline-primary btn-lg border rounded-pill" role="button" href="#">Log in</a>
                    </div>
                </div>
