        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <a class="text-bg-primary border rounded-pill border-0" href="#">&emsp14;Change Product Image &emsp13;</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col">
                    <div class="card" style="border-radius: 12px;">
                        <div id="editproduct_cardbody" class="card-body">
                            <h3>Change Product Image for <strong><?php echo $p['product_name']; ?></strong></h3>
                                        ...
                                        <div class="card-body" style="background: var(--bs-secondary-bg);border-radius: 10px;">
                                            <div class="row">
                                                ...
                                                <div id="business-info" class="col">
                                                    <form id="changeimage" action="changeimage.php" method="post" name="changeimage" enctype="multipart/form-data" class="mb-2">
                                                    ...
                                                    <div class="btn-group btn-group-sm" role="group">
                                                        <button class="btn btn-primary" type="submit" style="margin-right: 8px;border-radius: 10px;" name="submit" form="changeimage">Save changes</button>
                                                        <a class="btn btn-outline-primary" style="margin-right: 8px;border-radius: 10px;" href="./productview.php?id=<?php echo $p['product_id']; ?>">Cancel</a>
