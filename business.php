...
<head>
    ...
    <title>Integrations - Miagao Negosyo Center</title>
            ...
            <div class="row gy-4 gy-md-0" data-aos="fade-up">
                <div class="col-sm-12 col-md-6 col-lg-5 offset-lg-1 text-center text-md-start d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-center">
                    <div style="max-width: 350px;">
                        ...
                        <p class="text-muted my-4">With our tools powered by technology, we help your business stand above all else.<br><br></p><a class="btn btn-primary btn-lg me-2" role="button" href="#" style="border-radius: 800px;">Sign up</a><a class="btn btn-outline-primary btn-lg" role="button" href="#" style="border-radius: 800px;">Log in</a>
                    </div>
                </div>
            ...
            <div class="row row-cols-1 row-cols-md-2 mx-auto" data-aos="fade-up" data-aos-delay="50" style="max-width: 900px;">
                ...
                <div class="col-sm-6 d-md-flex align-items-md-end align-items-lg-center mb-5">
                    <div>
                        ...
                        <p class="text-muted mb-4">Get more prospects of businesses in our town based on ratings by our users..</p><a class="fw-bold link-primary mb-3" href="#">Learn more&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-arrow-narrow-right fs-3">
            ...
            <div class="row row-cols-1 row-cols-md-2 mx-auto" data-aos="fade-up" data-aos-delay="50" style="max-width: 900px;">
                ...
                <div class="col-sm-6 d-md-flex align-items-md-end align-items-lg-center mb-5">
                    <div class="ms-md-3">
                        ...
                        <p class="text-muted mb-4">See what the latest technology has to offer whether our local products or local enterprises.</p><a class="fw-bold link-primary" href="#">Learn more&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-arrow-narrow-right fs-3">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                <line x1="5" y1="12" x2="19" y2="12"></line>
                                <line x1="15" y1="16" x2="19" y2="12"></line>
                                <line x1="15" y1="8" x2="19" y2="12"></line>
